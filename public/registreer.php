...
<form action = "registreer_processing.php" method = "post">
	<table>
		<tr>
			<td>E-mail adres: </td>	<td><input type = "text" name = "email"></td><td>*</td>
		</tr>
		<tr>
			<td>Wachtwoord: </td>	<td><input type = "password" name = "wachtwoord"></td><td>*</td>
		</tr>
		<tr>
			<td>Voornaam: </td>	<td><input type = "text" maxlength="32" name = "voornaam"></td><td>*</td>
		</tr>
		<tr>
			<td>Achternaam: </td>	<td><input type = "text" maxlength="32" name = "achternaam"></td><td>*</td>
		</tr>
		<tr>
			<td>Adres: </td>	<td><input type = "text" name = "adres"></td><td>*</td>
		</tr>
		<tr>
		...
		<tr>
			<td>Telefoonnumer: </td>	<td><input type = "text" maxlength="10" name = "telefoonnummer"></td><td>*</td>
		</tr>
		<tr>
